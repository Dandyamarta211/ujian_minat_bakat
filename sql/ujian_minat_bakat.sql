...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Apr 2021 pada 12.21
...
(4, '::1', 'admin@admin', 1618988387),
(5, '::1', 'admin@admin', 1618988392);
...
(1, '127.0.0.1', 'Administrator', '$2y$12$caR2SIYjG5lwY1fM17ZdaO0UfAKV5ae0.7l.9GUBFyuT4phIMEMbW', 'dandy@dandy.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1618995066, 1, 'Admin', 'Istrator', 'ADMIN', '0');
...
--
ALTER TABLE `guru`
  ADD CONSTRAINT `guru_ibfk_1` FOREIGN KEY (`matkul_id`) REFERENCES `matkul` (`id_matkul`);
...
--
ALTER TABLE `kelas_dosen`
  ADD CONSTRAINT `kelas_dosen_ibfk_1` FOREIGN KEY (`dosen_id`) REFERENCES `guru` (`id_guru`),
...
--
ALTER TABLE `m_ujian`
  ADD CONSTRAINT `m_ujian_ibfk_1` FOREIGN KEY (`dosen_id`) REFERENCES `guru` (`id_guru`),
...
ALTER TABLE `tb_soal`
  ...
  ADD CONSTRAINT `tb_soal_ibfk_2` FOREIGN KEY (`dosen_id`) REFERENCES `guru` (`id_guru`);
