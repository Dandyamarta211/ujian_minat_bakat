...
class Master_model extends CI_Model {
    ...
    {
        $this->datatables->select('a.id_siswa, a.nama, a.email, b.nama_kelas, c.nama_jurusan');
        $this->datatables->select('(SELECT COUNT(id) FROM users WHERE username = a.nama) AS ada');
    ...
    public function getKelasGuru()
    {
        ...
        $this->datatables->join('guru', 'dosen_id=id_guru');
