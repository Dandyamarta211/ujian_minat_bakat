...
class Ujian extends CI_Controller {
	...
	public function add()
	{
        ...
        $data = [
			...
			'matkul'	=> $this->soal->getMatkulGuru($user->username),
			'guru'		=> $this->ujian->getIdGuru($user->username),
		];
	...
	public function validasi()
	{
		...
		$user 	= $this->ion_auth->user()->row();
		$dosen 	= $this->ujian->getIdGuru($user->username);
		$jml 	= $this->ujian->getJumlahSoal($dosen->id_guru)->jml_soal;
	...
	public function save()
	{
		...
		$dosen_id 		= $this->input->post('guru_id', true);
	...
	public function list_json()
	{
		...
		$list = $this->ujian->getListUjian($this->ses->id_siswa, $this->sws->kelas_id);
	...
	public function list()
	{
		...
		$data = [
			...
			'judul'		=> 'Ujian',
			'subjudul'	=> 'List Ujian',
			'sws' 		=> $this->ujian->getIdSiswa($user->username),
		];
		$this->load->view('_templates/dashboard/_header.php', $data);
	...
	public function index()
	{
		...
		$sws		= $this->sws;
		$h_ujian 	= $this->ujian->HslUjian($id, $sws->id_siswa);
